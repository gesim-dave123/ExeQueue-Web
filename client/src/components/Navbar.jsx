  ...
  return (
    <div className='flex justify-between min-h-[10vh] shadow-sm sticky top-0 backdrop-blur-md z-50'>
      ...
      <div className='hidden lg:flex items-center mr-25 pr-10 gap-7 scroll-smooth'>
        ...
        <a href = "#about" className='px-4 py-2 rounded-lg text-gray-700 hover:text-blue-600 transition-colors font-medium group relative'>About Us</a>
        <a href="#help" className='px-4 py-2 rounded-lg text-gray-700 hover:text-blue-600 transition-colors font-medium group relative'>Help</a>
        <a href ="#faq" className='px-4 py-2 rounded-lg text-gray-700 hover:text-blue-600 transition-colors font-medium group relative'>FAQs</a>
