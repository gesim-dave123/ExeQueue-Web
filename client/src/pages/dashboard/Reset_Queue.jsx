...
export default function Reset_Queue() {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-250 py-7 px-3 xl:px-0 xl:pl-1 xl:pr-7">
      <div className="w-full h-full px-7 flex flex-col items-start py-11 bg-white rounded-2xl">
        ...
        <div className="flex flex-col justify-between gap-12 w-full">
          <div className="flex w-full items-center flex-col md:flex-row justify-between gap-3">
            <div className="w-full flex justify-between flex-col items-start gap-6">
              <h3 className="font-semibold text-2xl">Reset Priority Queue</h3>
          ...
          <div className="flex w-full items-center flex-col md:flex-row justify-between gap-3">
            <div className="w-full flex justify-between flex-col items-start gap-6">
              <h3 className="font-semibold text-2xl">Restart Regular Queue</h3>
              <span className="text-xl text-left mb-3">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-8 w-full">
            ...
            <div className="flex flex-col gap-3 md:gap-6 w-full md:w-auto">
              ...
              <span className="text-base md:text-xl text-left">
            ...
            {/* Button */}
            <button
              className="w-full md:w-auto bg-[#EA4335] text-white py-4 px-6 rounded-xl text-center"
