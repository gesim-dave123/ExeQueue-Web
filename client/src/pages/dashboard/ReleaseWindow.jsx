      ...
      <div className="h-full w-full p-5 sm:p-8 lg:p-8 xl:pt-9 xl:p-10 bg-white rounded-2xl sm:rounded-3xl shadow-xs  lg:pb-[39vh] xl:pb-[56vh]">
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-start gap-6 mb-10">
          ...
          <button
            ...
            className="bg-[#1A73E8] w-full md:w-auto min-w-[150px] text-sm sm:text-base lg:text-lg text-white font-medium px-4 sm:px-6 lg:px-4 py-2 sm:py-3 lg:py-3 rounded-lg sm:rounded-xl lg:rounded-2xl transition duration-200 hover:bg-[#1669c1]"
          >
            Release Window 1
          </button>
        </div>
